...
namespace Adveshta.DataAccess.Migrations
{
    ...
    [Migration("20260827190554_rullable_unassigned_roleemp")]
    partial class rullable_unassigned_roleemp
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Adveshta.Model.Employee.Employee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Adveshta.Model.Employee.EmployeeAppRoleMap", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Adveshta.Model.TenantModels.Tenant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Locale = "en-IN",
                            Name = "Code Dev",
                            OnboardingDate = new DateTime(2026, 8, 27, 19, 5, 54, 134, DateTimeKind.Utc).AddTicks(6118),
                            Status = 1,
            ...
            modelBuilder.Entity("Adveshta.Model.Employee.Employee", b =>
                {
                    ...
                    b.HasOne("Adveshta.Model.TenantModels.Tenant", "Tenant")
                        .WithMany()
                    ...
                    b.HasOne("Adveshta.Model.Auth.ApplicationUser", "User")
                        .WithOne("Employee")
                        .HasForeignKey("Adveshta.Model.Employee.Employee", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Adveshta.Model.Employee.EmployeeAppRoleMap", b =>
                {
                    ...
                    b.HasOne("Adveshta.Model.Employee.Employee", "AssignedBy")
                        .WithMany()
                        .HasForeignKey("AssignedById")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Adveshta.Model.Employee.Employee", "Employee")
                        .WithMany()
                    ...
                    b.HasOne("Adveshta.Model.Employee.Employee", "ReassignedBy")
                        .WithMany()
