...
namespace Adveshta.DataAccess.Migrations
{
    ...
    [Migration("20260828162055_rename_tenant_organization")]
    partial class rename_tenant_organization
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Adveshta.Model.OrganizationModel.Organization", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Locale = "en-IN",
                            Name = "Code Dev",
                            OnboardingDate = new DateTime(2026, 8, 28, 16, 20, 54, 616, DateTimeKind.Utc).AddTicks(47),
                            Status = 1,
