...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Aegis.Model.EmployeeModels.Employee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Aegis.Model.EmployeeModels.EmployeeAppRoleMap", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Aegis.Model.Master.OrganizationType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Aegis.Model.Master.ProspectStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Aegis.Model.OrganizationModel.EmployeeOrganization", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Aegis.Model.OrganizationModel.Organization", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Aegis.Model.ProspectModel.Prospect", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Aegis.Model.EmployeeModels.Employee", b =>
                {
                    ...
                    b.HasOne("Aegis.Model.OrganizationModel.Organization", "Organization")
                        .WithMany()
                    ...
                    b.HasOne("Aegis.Model.Auth.ApplicationUser", "User")
                        .WithOne("Employee")
                        .HasForeignKey("Aegis.Model.EmployeeModels.Employee", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Aegis.Model.EmployeeModels.EmployeeAppRoleMap", b =>
                {
                    ...
                    b.HasOne("Aegis.Model.EmployeeModels.Employee", "AssignedBy")
                        .WithMany()
                        .HasForeignKey("AssignedById");

                    b.HasOne("Aegis.Model.EmployeeModels.Employee", "Employee")
                        .WithMany()
                    ...
                    b.HasOne("Aegis.Model.EmployeeModels.Employee", "ReassignedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("Aegis.Model.OrganizationModel.Organization", b =>
                {
                    b.HasOne("Aegis.Model.Master.OrganizationType", "OrganizationType")
                        .WithMany()
            ...
            modelBuilder.Entity("Aegis.Model.ProspectModel.Prospect", b =>
                {
                    b.HasOne("Aegis.Model.EmployeeModels.Employee", "CreatedBy")
                        .WithMany()
                    ...
                    b.HasOne("Aegis.Model.Master.ProspectStatus", "ProspectStatus")
                        .WithMany("Prospects")
                        .HasForeignKey("StatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Aegis.Model.EmployeeModels.Employee", "UpdatedBy")
                        .WithMany()
